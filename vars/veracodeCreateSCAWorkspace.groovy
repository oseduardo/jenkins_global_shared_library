            ...
            if(wkspID != "") { //A workspace with wkspName name exists!
                ...
                if(intAgents != 0) {
                    ...
                    if(agentID != "") { //A CLI agent with <wkspName>_CLI_Agent name exists!
                        ...
                        sh "http --auth-type veracode_hmac POST https://api.veracode.com/srcclr/v3/workspaces/${wkspID}/agents --ignore-stdin agent_type=CLI name=${wkspName}_CLI_Agent > myAgent.json"
